package com.zte.android.lib.media.gallery.photoloader.utils;
...
public class ContentUtils {
    ...
    private static SharedPreferences getSharedPreferences() {
        return PreferenceManager.getDefaultSharedPreferences(Configuration.mContext);
    }
    ...
    public static Uri getSharedPreferenceUri(final int preferenceId) {
        String uriString = getSharedPreferences().getString(Configuration.mContext.getString(preferenceId), null);
    ...
    public static void setSharedPreferenceUri(final int preferenceId, @Nullable final Uri uri) {
        ...
        if (uri == null) {
            editor.putString(Configuration.mContext.getString(preferenceId), null);
        } else {
            editor.putString(Configuration.mContext.getString(preferenceId), uri.toString());
        }
        editor.apply();
    }
    ...
    public static boolean deleteFile(Context context, @NonNull final File file) {
        ...
        if (Build.VERSION.SDK_INT == Build.VERSION_CODES.KITKAT) {
            ...
            try {
                ...
                Log.e(TAG, "Error when deleting file " + file.getAbsolutePath());
                return false;
            }
        }
