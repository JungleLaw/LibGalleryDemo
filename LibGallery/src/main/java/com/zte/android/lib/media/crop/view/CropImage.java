...
package com.zte.android.lib.media.crop.view;
...
import com.zte.android.lib.media.crop.CropActivity;
...
public final class CropImage {
    ...
    /**
     * TestPayActivity if we can open the given Android URI to test if permission required error is thrown.<br>
    ...
    /**
     * Create {@link ActivityBuilder} instance to start {@link com.zte.android.lib.media.crop.CropActivity} to crop the given image.<br>
     * Result will be received in {@link Activity#onActivityResult(int, int, Intent)} and can be retrieved
     * using {@link #getActivityResult(Intent)}.
     *
